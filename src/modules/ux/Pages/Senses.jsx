  ...
  return (
    <Fragment>
      <div className="uxContent">
        ...
        <div className="g1">
          <ZoomImage
            src="/images/ux/senses_bm.JPEG"
            enlargedSrc="/images/ux/senses_b.JPEG"
          />
        </div>
        <div className="uxText">
          <div className="uxOverview">
            ...
            <p>
              ...
              <span className="uxHighlight">nociception</span> beyond the body.
            </p>
            ...
            <p>
              ...
              , Yuying Wang (Abbey) , Jakob Prüfer
            </p>
          ...
          <main className="uxMain">
            ...
            <p>
              ...
              Romit and me started with fresh eyes and little clue. Preliminary
            ...
            <p>
              ...
              design anything that would cause physical pain, yet the brief
              asked us to extend nociception beyond the body. While the glove
              prototype constituted a symbolic representation of this sense,
              Romit stimulated a different interpretation. Maybe we could use
              just slight nociceptive pain for good: to remind users of a
              ...
              of the first week therefore became an exoskeleton of sorts, made
            ...
            <p>
              The first week feedback session revealed that our prototype had to
              be at least somewhat functional in the class room – it couldn’t
              just be recorded or “faked” on video. With the short amount of
              time given, the glove idea therefore didn’t seem feasible and was
              abandoned. For our other approaches, we would have to consider
              practicability in week 2. The first presentation in front of the
              class brought out some nerves for me; wrapping up week 1 felt very
              rewarding.
            </p>
            <h3>Week 2</h3>
            <p>
              Following up from our behaviour change approach from first week,
              we considered various behaviours that could be affected by using a
              slight nociceptive pain. Ideas included:
              <ul>
              ...
              whether this was the way we had to think about our designs;
              projects that had gotten good feedback in the first week often
              more resembled artistic installations rather than consumer
              products.
            </p>
            <div className="g1">
              <ZoomImage
            ...
            <p>
              ...
              investigates the effect of visual information on the perception of
              body ownership. Specifically, participants start associating a
              rubber hand with their own body when they observe it being stroked
              while their own unseen hand is synchronously stroked
              <span className="footNote" onClick={executeScroll}>
                [4]
              </span>
              ...
              . The phenomenon was first reported by Botvinick and Cohen in 1998
              <span className="footNote" onClick={executeScroll}>
                [6]
              </span>
            ...
            <p>
              ...
              cubes, we wanted to test the experience of thermal nociception in
              different settings. We hypothesized that blocking vision and
              hearing would increase the perception of cold because it was the
              main focus. For that purpose we build a cardboard box, sealed off
              by cotton wool to wear on the head. We also integrated a pair of
              headphones in the box. In our live demonstration, we let one
              person from the class rate their pain perception while we put ice
              cubes on the back of their hands in three different conditions:
              <ol>
                <li>no distraction</li>
                <li>a cardboard box to impair vision and</li>
                <li>
                  a cardboard box and music playing through the headphones. The
                  song played was “Bonnie and Clyde” by Serge Gainsborough. We
                  used over-ear closed headphones and the participant didn’t
                  hear talking with the music on.
                </li>
              </ol>
            </p>
            <p>
              ...
              nature of the demonstration and the one-person sample size was no
              scientific proof, instead our focus was on the participant’s
              experience. We received vivid feedback from the class, mostly with
              suggestions how we could add to the setup – this showed that our
              outcome was not final, but still in the experimental stage.
            </p>
            ...
            <p>
              <ul>
                ...
                <li>Being a skilled presenter is integral for a UX designer</li>
                <li>
            ...
            <div className="bib" ref={bib}>
              <ol>
                ...
                <li>
                  ...
                  and neuropathic pain. <i>Journal of neurology</i>, 265(2), pp.
                  231–238.{" "}
                  <a
                ...
                <li>
                  Botvinick, M. and Cohen, J. (1998). Rubber hands ‘feel’ touch
                  that eyes see. <i>Nature</i>, 391(6669), p. 756.{" "}
