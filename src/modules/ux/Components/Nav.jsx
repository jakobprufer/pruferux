...
export default function Nav() {
  ...
  const [U4Open, setU4Open] = useState(false);
    ...
    <div className="uxSidebar">
      ...
      <div className="uxSidebarText">
        <nav className="uxNav">
          ...
          <div className="uxNavSection">
            <div className="uxButton" onClick={toggleU3}>
              <svg
                className={classNames(
                  "uxArrow",
                  { turned90: U3Open },
          ...
          <div className="uxNavSection">
            <div className="uxButton" onClick={toggleU4}>
              <svg
                className={classNames(
                  "uxArrow",
                  { turned90: U4Open },
            ...
            <div className={U4Open ? "uxIntroIn" : "uxIntroOut"}>
              <NavLink to="/projects/micro" className="uxNavProject">
                Saige
              </NavLink>
            </div>
          </div>
