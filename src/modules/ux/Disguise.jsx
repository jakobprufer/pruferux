        ...
        <div className="uxContent">
          ...
          <div className="uxText">
            <div className="uxOverview">
              ...
              <p>
                Design a way to <span className="uxHighlight">manipulate</span>{" "}
                and{" "}
                <span className="uxHighlight">
                  deceive perceptual recognition
                </span>
                .
              </p>
            ...
            <main className="uxMain">
              ...
              <p>
                ...
                Disguising oneself can mean pretending to be something or
                someone else as well as hiding and avoiding detection
                altogether. The topic seemed to resonate with everyone in our
                group - from the get-go, absorbing and amusing associations
                started flowing in conversation. We came up with various
                problems that we thought could use a solution. In the area of
                privacy and anti-surveillance protection, these included
                traceable information that we leave in the waste bin (like
                packaging and letters), unique keyboard typing patterns that can
                identify you like a finger print, but also embarrassing noises
                you might want to mask in the bathroom. We felt inspired by
                “Accessories for the Paranoid”, a design project around gadgets
                that feed technology with random data to blur users' digital
                footprint
                <span className="footNote" onClick={executeScroll}>
                  [4]
                </span>
              ...
              <p>
                ...
                design with speakers or fans that could be disguised as
                something more decorative. We talked about deep fakes and the
                disguising function of clothing; we discussed the idea that you
                might be more likely to gain entrance to a building when wearing
                a high visibility jacket like a construction worker. For our
                artefact analysis, we focused on objects we associated with
              ...
              <p>
                We then decided on two areas to focus on in parallel: the first
                was handwriting alteration. For this purpose, we experimented
                with altering pens so they were unstable, weighted unusually or
                harder to grip as ways of making personal handwriting
                unrecognisable. It was harder to write with some of these pen
                prototypes and the modification changed some characters, but we
                were unsure whether the effect was strong enough to make
                handwriting unidentifiable.
              </p>
              ...
              <p>
                The second idea was based on the problem of phone conversations
                in public transport or crowded spaces. To avoid strangers
                eavesdropping on private information or intimate conversation,
                we envisioned a sound-damping face mask with an integrated
                microphone and attached earphones. Further research confirmed
                that the frequency of around 1-4 kHz is crucial for speech
                intelligibility
                <span className="footNote" onClick={executeScroll}>
                  [5]
                </span>
                . Most consonants are pronounced in this area. Vowels on the
                other hand, the core tone of which is located somewhere between
                100 and 300 Hz, seem to play a less important role. To showcase
                the frequency allocation, we 3D printed a recorded spectrogram
                of the vowels A, E, I, O and U, inspired by an online 2D
                spectrogram visualizer we had found.
              </p>
              ...
              <div className="caption">
                3D printed spectrogram of the five vowels showing higher volumes
                in the low frequencies. Right: experimentation with live
                spectogram captured by Wan
              </div>
              <audio controls>
              ...
              <p>
                In our first week presentation we then presented a quick
                cardboard prototype of a sound-damping mask (filled with mostly
                wool and other fabrics) as well as the pens described above.{" "}
              </p>
              <div className="g1">
                <ZoomImage
              ...
              <h3>Week 2</h3>
              <p>
                Feedback from week 1 had favoured the mask idea; suggestions
                were to construct the mask so it would isolate the mouth area
                better and to play “noise-cancelling” sounds to counter the
                relevant frequencies. Students had rightfully noted that
                reception might be an issue when calling in the London
                Underground, which is located in depth half way to the Earth’s
                core. So in week 2 we decided to take the mask idea and refine
                it as much as possible, making it a luxury high-tech accessory
                with branding and packaging; then to present it in a sort of
                unveil keynote. This time we wanted to make sure the mask was
                ...
                shell, one covering nose and mouth and one covering only the
                mouth.
              </p>
              <div className="uxImgRowLeft">
                <div className="uxImg1">
              ...
              <p>
                We made full use of LCC’s 3D workshop: We printed the models
                again using the Ultimaker FDM 3D printers, glued foam from
                studio acoustic panels inside the masks and fixated outer fabric
                as finish. For headphones and microphone, we integrated a bought
                headset into the design, hiding the microphone inside the
                insulation. One version of the mask we kept in the tech-wear
                finish with the shiny PETG material reflecting in many small
                angled squares, one version we covered in more upscale-looking
                creased fabric and finished with golden buttons on the outside.
              </p>
              {/* <div className="g11">
                <video
                  className="uxVideo"
              ...
              <p>
                We designed a quick branding for the mask and named it
                “Secreto”, then took product pictures with branded paper
                packaging. The product would be advertised as follows:
              </p>
              <p>
                <i>
                  With this handmade designer mask, make your conversations
                  exclusive and keep what is most valuable hidden from intrusive
                  ears. Advanced sound blocking foam ensures breathable comfort
                  and unparalleled privacy. A dynamic microphone will pick up
                  words precisely and create a space of privacy amidst the
                  crowd.
                </i>
              </p>
              <div className="g11asym">
              ...
              <p>
                ...
                application was still in the realm of speculation, the
                realisation was well done. I personally think the mask
                emphasizes the size of my nose a bit too much :)
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  coordination is on point and the pitch is within the time
                  limit. Even though the demonstration was successful, it could
                  have been executed a little smoother.
                </li>
              ...
              <div className="bib" ref={bib}>
                <ol>
                  ...
                  <li>
                    Roussi, A. (2020) ‘Resisting the rise of facial
                    recognition’, <i>Nature</i>, 587(7834), pp. 350–353.
                    Available at:{" "}
                    <a
                  ...
                  <li>
                    ...
                    Neural Networks: A Systematic Review’, <i>IEEE Access</i>,
                    7, pp. 19143–19165. doi:{" "}
                    <a
                  ...
                  <li>
                    Hitti, N. (2019) “ Accessories for the Paranoid uses fake
                    data to stop your devices spying on you,” <i>Dezeen</i>, 27
                    June. Available at:{" "}
                    <a
                  ...
                  <li>
                    DPA Microphones (2021) Facts about speech intelligibility:
                    Human voice frequency range, <i>DPA Microphones</i>,
                    Available at:{" "}
                    <a
