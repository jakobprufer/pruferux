            ...
            <nav className="uxNav">
              ...
              <div className="uxNavSection">
                ...
                <div className={U1Open ? "uxIntroIn" : "uxIntroOut"}>
                  ...
                  <a
                    href="/ux/birdsong"
                    className="uxNavProject active uxHighlight"
                  >
                    UX of Birdsong
                  </a>
          ...
          <div className="uxText">
            ...
            <main className="uxMain">
              ...
              <p>
                ...
                comes to design. We use the word imagination, derived from the
                “image”, even when what we imagine are sounds
                <span className="footNote" onClick={executeScroll}>
                  [1]
                </span>
                . All the more inviting was the challenge to design around
                sound, specifically birdsong in an urban environment. Unlike
                most animals, birds use identical sounds in patterns like we do
                with our human phonology - even though the sounds don’t seem to
                carry the same depth of meaning
                <span className="footNote" onClick={executeScroll}>
                  [2]
                </span>
                . Birdsong has served as inspiration for various classical
                composers{" "}
                <span className="footNote" onClick={executeScroll}>
                  [3]
                </span>{" "}
                ...
                sunrise-announcing birdsong that haunts me when I try to fall
                asleep after a night of dancing.
              </p>
              <div className="g1">
                <ZoomImage
              ...
              <p>
                ...
                different areas of London, including central Knightsbridge and
                South Bank as well as leafy Sydenham. A{" "}
                <a
                  href="https://www.researchgate.net/publication/38303920_Soundwalking_as_a_methodology_for_understanding_soundscapes"
                  target="_blank"
                >
                ...
                is a walk with focus on the sonic environment. I did mine in
                Forest Hill and Catford at around 5pm in early winter darkness.
                The air had a stale quality, lacking altogether the freshness of
                an evening breeze, and a muffling mist had settled over the
                hills, blurring the distant skyscrapers, and damping the
                soundscape. Only twice I heard birds, in two different parks I
                crossed, but calling from an indiscernible location and quieting
                as I tried to walk towards the source. Both times it seemed to
                be the same species, screeching in a short high-pitched tone. I
                heard various birds of the mechanical kind – with planes
                crossing over towards Heathrow in intervals of less than 30
                seconds - as well as distant police sirens and dog barking,
                cars, trains, people talking and laughing. My favourite moment
                was standing in a tucked-away, pitch-black meadow in Ladywell
                Fields - with all this London soundscape still audible but at
                the same time hidden away from sight.{" "}
              </p>
              <div className="g111">
                <ZoomImage
              ...
              <p>
                ...
                identified common themes. An observation that stood out to all
                of us were the many layers of sound, most of them urban noises.
                The birdsong was routinely hidden beneath them, only noticed
                when listening intentionally. From this notion came our first
                prototype: a sound “sandwich”, made from layers of different
                materials representing natural and urban sounds. To further
                develop this idea of representing sound in a physical form, we
                then listened to the recordings individually and drew on paper
                what came to our head. Curiously, our sketches were very similar
                for individual bird species. We used sharp quick lines for
                screechy sounds and dainty, squiggly lines for melodic singsong.
                Most of us used notation in lines from left to right reminiscent
                of traditional musical notation. Following advice from our
                tutorial, we tried to bring these shapes into 3D form using
                materials such as toothpicks, fabric, wire and paper.
              </p>
              <audio controls>
              ...
              <p>
                ...
                grey-painted cardboard model and placed sound representations
                like mentioned above in places where we had heard them. This
                included urban sounds such as a police siren and crowd chatter
                as well as birdsong. I our presentation, we got one participant
                to listen to recordings we had made an identify the
                corresponding sound representation on our map, which they did
                with surprising accuracy. Nonetheless, feedback was mostly
                critical. The model was too low in fidelity, the top down view
                didn’t represent a very vivid experience and the birdsong was
              ...
              <h3>Week 2</h3>
              <p>
                After we were all a bit disappointed with the first week
                feedback, the pressure was on to step it up in week 2. We
                thought about the relationship of birdsong and time of day, as
                we mostly associated birdsong with sunrise and sunset times.
                This coincided with our observations in the soundwalk analysis.
                One idea was to create a sunrise alarm clock that included
                birdsong. Following further literature review, we then decided
                to focus on birdsong in connection to urban light pollution.
                Birds rely on light as cue for their activity and singing
                patterns
                <span className="footNote" onClick={executeScroll}>
                  [5]
                </span>
                . Artificial light at night makes birds sing earlier both in
                dusk and dawn than they would naturally
                <span className="footNote" onClick={executeScroll}>
                  [6]
                </span>
                ...
                , leading to irregularities in their inner body clock and
                disrupted sleep
                <span className="footNote" onClick={executeScroll}>
                  [8]
                </span>
                . Other negative effects of artificial light include
                disorientation of migrating birds
                <span className="footNote" onClick={executeScroll}>
                  [6]
                </span>
                ...
                . These findings added a new purpose that we could incorporate
                in the design if we were able to raise awareness for the issue.
              </p>
              <div className="g111">
                <ZoomImage
              ...
              <p>
                ...
                concept of an augmented bird nest that would play sounds based
                on light shun on it. We built the nest using twigs from a
                neighbouring park and reinforced it with wire. We then placed
                the sensor and microcontroller in the middle of the nest covered
                by more twigs; via a USB cable, we could now trigger any
                parameter in our music software, Ableton Live. At different
                levels of light, low pass filters would open to make more and
                more birds audible - climaxing in a full choir of reverbed
                birdsong and loud screeching. The light sensor also controlled a
                white noise synthesizer, making the pitch higher with more light
                and adding a slightly threatening tone to the installation.{" "}
              </p>
              <div className="g11">
                <ZoomImage
                ...
                <video controls className="uxVideo" width="720" height="1280">
                  <source
                    src="/images/ux/birdsong1.mp4#t=0.001"
                    type="video/mp4"
                  />
                </video>
              </div>
              <div className="g1">
                <video controls className="uxVideo" width="1920" height="1080">
                  <source
                    src="/images/ux/birdsong2.mp4#t=0.001"
                    type="video/mp4"
                  />
                </video>
              </div>
              ...
              <p>
                We dimmed the room for presentation, setting the scene for the
                nest in a in a city night-time setting. Participants were given
                a flashlight and instructed to examine the nest. The experience
                of surprise and interactivity with the light-reactive sound
                worked very well. In addition to the eerie sound sphere that was
                triggered, the twigs of the nest also created a network of
                shadows that wandered around the darkened room with every move
                of the flashlight. Feedback was positive; one observation was
                that the nest could work well in a natural history museum.
                Suggestions for improvement included better disguise of the
                technology (we had set up our laptop next to the nest instead of
                hiding it) and the introduction of birds sounding like they were
                in pain at maximum brightness to amplify the light pollution
                message.
              </p>
              <div className="g1">
                <ZoomImage
              ...
              <div className="bib" ref={bib}>
                <ol>
                  <li>
                    Oliveros, P. (2011) “Auralizing in the Sonosphere: A
                    vocabulary for inner sound and sounding,”{" "}
                    <i>Journal of Visual Culture</i>, 10(2), pp. 162–168.
                    Available at:{" "}
                    <a
                  ...
                  <li>
                    Pentreath, R. (2021) 13 pieces of classical music inspired
                    by birdsong, <i>Classic FM</i>. Available at:{" "}
                    <a
                  ...
                  <li>
                    David, B. (2022) “Bird and birdsong encounters improve
                    mental health, study finds” <i>Guardian</i>, 27 October.
                    Available at:{" "}
                    <a
                  ...
                  <li>
                    Da Silva, A. and Kempenaers, B. (2017) “Singing from north
                    to south: Latitudinal variation in timing of dawn singing
                    under natural and artificial light conditions,”{" "}
                  ...
                  <li>
                    ...
                    (2015). <i>Max-Planck-Gesellschaft</i>. Available at:{" "}
                    <a
                  ...
                  <li>
                    Aulsebrook, A. E. et al. (2020) ‘White and Amber Light at
                    Night Disrupt Sleep Physiology in Birds’,{" "}
                    <i>Current Biology</i>, 30(18), pp. 3657-3663.e5. doi:{" "}
                    <a
                  ...
                  <li>
                    ...
                    sleeping under light at night in Forest and urban great
                    tits,”{" "}
                    <i>
                      Proceedings of the Royal Society B: Biological Sciences
                    </i>
